        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden mb-12">
          <div className="p-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              Complete Guide to Uni-Assist Application
            </h2>
            <p className="text-lg text-textp mb-8">
              Uni-Assist is the centralized application portal for many German
              universities. Follow these steps carefully to ensure your
            ...
            <div className="space-y-12">
                ...
                <div>
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold text-gray-800">
                      Fill the Online Uni-Assist Form
                    </h3>
                  </div>
                  <p className="text-textp mb-4">
                    Click the button below to access the Uni-Assist application
                    portal and select your desired course of study
                    (Studienkolleg/Bachelor/Master).
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div>
                  ...
                  <p className="text-textp">
                    Carefully research and select the study programs that match
                    your academic background and career goals. Consider factors
                    like:
                  </p>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div>
                  ...
                  <p className="text-textp mb-4">
                    Prepare high-quality scans of all required documents and
                    upload them to your Uni-Assist account.
                  </p>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div>
                  ...
                  <p className="text-textp mb-4">
                    Mail a complete set of attested documents to Uni-Assist for
                    evaluation. All documents must be notarized copies.
                  </p>
                  ...
                  <div className="mt-4 bg-yellow-50 border border-yellow-100 rounded-lg p-4">
                    ...
                    <p className="text-yellow-800">
                      To maximize admission chances, apply to up to 10 relevant
                      courses/universities through Uni-Assist.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div>
                  ...
                  <p className="text-textp mb-4">
                    Uni-Assist charges processing fees for each application. The
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="bg-white border rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-sm text-textp">
                          Direct online payment through Uni-Assist portal
                        </p>
                      </div>
                      <div className="bg-white border rounded-lg p-4 shadow-sm">
                        <div className="bg-blue-100 w-12 h-12 rounded-full flex items-center justify-center mb-3">
                        ...
                        <p className="text-sm text-textp">
                          Through someone with foreign currency account in
                          Pakistan
                        </p>
                      </div>
                      <div className="bg-white border rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-sm text-textp">
                          By relatives/friends living abroad
                        </p>
                      </div>
                    </div>
                  </div>
